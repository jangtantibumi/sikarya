...
<head>
    ...
    <script>
        window.ERP_FEATURES = @json($featureFlags ?? []);
    </script>
    <script>
        (() => {
            try {
    ...
    <link rel="stylesheet" href="/css/strategic-erp.css?v={{ filemtime(public_path('css/strategic-erp.css')) }}">
    <!-- Modern Premium Font -->
...
<body>
    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            @include('partials.strategic-erp')
            @include('partials.alumni-network')
    ...
    <script src="/js/strategic-erp.js?v={{ filemtime(public_path('js/strategic-erp.js')) }}"></script>
