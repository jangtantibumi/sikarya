        ...
        <div class="login-body">
            ...
            <form action="{{ route('portal.login.attempt') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="customer_code" class="form-control" placeholder="Kode Customer (CUST-XXXX)" required value="{{ old('customer_code') }}">
                </div>
                <div class="form-group">
                    <i class="ph ph-phone"></i>
                    <input type="text" name="phone" class="form-control" placeholder="Nomor Handphone" required value="{{ old('phone') }}">
                </div>
