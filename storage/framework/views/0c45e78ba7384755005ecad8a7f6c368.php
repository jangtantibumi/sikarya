...
<div class="sl-flex sl-relative sl-max-w-full sl-py-2 sl-pl-3">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 <?php if($expandable): ?> sl-cursor-pointer <?php endif; ?>">
        <div class="sl-flex sl-items-center sl-max-w-full">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (! ($isArrayBody)): ?>
                <div class="sl-flex sl-items-baseline sl-text-base">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($required || $deprecated): ?>
                        ...
                        <div class="sl-flex sl-items-center">
                            ...
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deprecated): ?>
        ...
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasChildren && !is_null($example) && $example !== ''): ?>
...
<?php /**PATH D:\suba-erp-master-local-latest\vendor\knuckleswtf\scribe\resources\views\themes\elements\components\field-details.blade.php ENDPATH**/ ?>