...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="brand">
            <small><?php echo e($company->name); ?></small>
        </div>
        <div style="padding: 0 24px; margin-bottom: 16px;">
            <div style="font-size: 12px; color: var(--text-muted); text-transform: uppercase; font-weight: bold; margin-bottom: 8px;"><?php echo e($user->isManager() ? 'Manager Workspace' : 'My Workspace'); ?></div>
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->isManager()): ?>
        <a class="nav-item" onclick="switchView('goals')"><i class="fa-solid fa-bullseye"></i> Set KPI Tim</a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Illuminate\Support\Str::contains(strtolower($user->job_title ?? ''), ['kasir', 'toko', 'supervisor operational branch'])): ?>
            <a class="nav-item" onclick="switchView('pos')"><i class="fa-solid fa-cash-register"></i> Mesin Kasir (POS)</a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Illuminate\Support\Str::contains(strtolower($user->job_title ?? ''), ['inventory', 'gudang', 'warehouse'])): ?>
            <a class="nav-item" href="<?php echo e(route('inventory.dashboard')); ?>"><i class="fa-solid fa-boxes-stacked"></i> Gudang & Stok & Warehouse</a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Illuminate\Support\Str::contains(strtolower($user->job_title ?? ''), ['purchasing'])): ?>
            <a class="nav-item" onclick="switchView('purchasing')"><i class="fa-solid fa-cart-shopping"></i> Purchasing & Suplier</a>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(\Illuminate\Support\Str::contains(strtolower($user->job_title ?? ''), ['produksi', 'bakery', 'pastry'])): ?>
        ...
        <div style="padding: 0 24px; margin-top: auto; margin-bottom: 24px;">
            <div class="card" style="padding: 16px; background: rgba(0,0,0,0.3); margin-bottom: 16px;">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <a href="/storage/<?php echo e($doc->file_path); ?>" target="_blank" style="display: block; font-size: 11px; color: var(--accent); text-decoration: none; margin-bottom: 4px;"><i class="fa-solid fa-download"></i> <?php echo e($doc->title); ?></a>
            ...
            <div class="card" style="padding: 16px; background: rgba(0,0,0,0.3);">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($leaveQuotas && $leaveQuotas->count() > 0): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $leaveQuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div style="display: flex; justify-content: space-between; font-size: 13px;">
                            <span>Tahun <?php echo e($quota->year); ?></span>
                            <strong style="color: var(--success);"><?php echo e($quota->remaining()); ?> Hari</strong>
                        </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeLeave): ?>
                    <form method="post" action="<?php echo e(route('master-demo.leave.cancel', $activeLeave->id)); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="user-pill" style="width: 100%; margin-top: 10px; background: rgba(239,68,68,0.2); color: var(--danger); border: 1px solid var(--danger); font-size: 11px; cursor: pointer;">Batalkan Cuti (<?php echo e($activeLeave->start_date->format('d/m')); ?>)</button>
                    </form>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    ...
    <main class="main-view">
        ...
        <header class="top-bar">
            <div style="display: flex; align-items: center; gap: 16px;">
                ...
                <div>
                    ...
                    <p id="view-subtitle" style="margin:5px 0 0 0; color:var(--text-muted); font-size: 14px;">Selamat bekerja di divisi <strong><?php echo e($user->divisionLabel()); ?></strong>.</p>
                </div>
            </div>
            ...
            <div style="display: flex; gap: 16px; align-items: center;">
                ...
                <div class="user-info-top">
                    <div style="text-align: right;">
                        <strong style="display: block; color: var(--text-heading);"><?php echo e($user->name); ?></strong>
                        <small style="color: var(--text-muted);"><?php echo e($user->job_title); ?> · <?php echo e($user->divisionLabel()); ?></small>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->profile_picture_path): ?>
                        <img src="/storage/<?php echo e($user->profile_picture_path); ?>" alt="Profile" class="avatar-top">
                    <?php else: ?>
                        <div class="avatar-top"><?php echo e(substr($user->name, 0, 1)); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            </div>
        ...
        <div id="view-dashboard" class="view-section active">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('attendance_success')): ?>
                <div style="background: rgba(12, 53, 39,0.2); border: 1px solid var(--success); color: var(--success); padding: 12px 16px; border-radius: 8px; margin-bottom: 16px; font-size: 13px;">
                    <i class="fa-solid fa-check-circle"></i> <?php echo e(session('attendance_success')); ?>

                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('attendance_error')): ?>
                <div style="background: rgba(239,68,68,0.2); border: 1px solid var(--danger); color: var(--danger); padding: 12px 16px; border-radius: 8px; margin-bottom: 16px; font-size: 13px;">
                    <i class="fa-solid fa-exclamation-circle"></i> <?php echo e(session('attendance_error')); ?>
            ...
            <div class="card" style="margin-bottom: 24px; border-left: 4px solid var(--accent);">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <h3 style="margin: 0 0 4px 0; border: none; padding: 0;">Absensi Hari Ini (<?php echo e(now()->format('d M Y')); ?>)</h3>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activeAttendance): ?>
                            <span style="font-size: 13px; color: var(--success);"><i class="fa-solid fa-circle" style="font-size: 8px;"></i> Clock in: <?php echo e($activeAttendance->clock_in->timezone(config('app.timezone', 'Asia/Jakarta'))->format('H:i')); ?> WIB</span>
                        <?php else: ?>
                    ...
                    <div style="display: flex; gap: 8px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$activeAttendance): ?>
                            <form method="POST" action="<?php echo e(route('master-demo.attendance.clock-in')); ?>">
                                <?php echo csrf_field(); ?>
                                <div style="margin-bottom: 12px;">
                                    ...
                                    <select name="shift_id" class="form-control" style="font-size: 12px; padding: 6px; width: 100%; border: 1px solid var(--panel-border);  border-radius: 4px;" required>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $shifts ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <option value="<?php echo e($shift->id); ?>" <?php echo e($user->default_shift_id == $shift->id ? 'selected' : ''); ?>>
                                                <?php echo e($shift->name); ?> (<?php echo e(\Carbon\Carbon::parse($shift->start_time)->format('H:i')); ?> - <?php echo e(\Carbon\Carbon::parse($shift->end_time)->format('H:i')); ?>)
                                            </option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    </select>
                                </div>
                        ...
                        <?php elseif(!$activeAttendance->clock_out): ?>
                            <form method="POST" action="<?php echo e(route('master-demo.attendance.clock-out')); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-danger" style="gap: 6px;"><i class="fa-solid fa-right-from-bracket"></i> Clock Out</button>
                            </form>
                        <?php else: ?>
                            <span class="pill success">Selesai (<?php echo e($activeAttendance->clock_out->timezone(config('app.timezone', 'Asia/Jakarta'))->format('H:i')); ?>)</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="card" style="margin-bottom: 24px;">
                <h3>Tim <?php echo e($user->divisionLabel()); ?></h3>
                <?php
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 12px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $teamMembers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php $memberAtt = $member->attendances()->whereDate('clock_in', today())->first(); ?>
                        <div style="background: rgba(0,0,0,0.04); padding: 12px; border-radius: 8px; border-left: 3px solid <?php echo e($memberAtt ? 'var(--success)' : 'var(--warning)'); ?>;">
                            <strong style="font-size: 13px; display: block;"><?php echo e($member->name); ?></strong>
                            <span style="font-size: 11px; color: var(--text-muted);"><?php echo e($member->job_title); ?></span>
                            <div style="font-size: 11px; margin-top: 4px; color: <?php echo e($memberAtt ? 'var(--success)' : 'var(--warning)'); ?>;">
                                <?php echo e($memberAtt ? 'Hadir ' . $memberAtt->clock_in->timezone(config('app.timezone', 'Asia/Jakarta'))->format('H:i') : 'Belum hadir'); ?>
            ...
            <div class="grid-2">
                ...
                <section class="card">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                        <h3 style="margin: 0; border: none; padding: 0;">Daily Report (<?php echo e(today()->format('d M Y')); ?>)</h3>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($todayReport): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($todayReport): ?>
                        <div style="background: var(--bg-main); padding: 16px; border-radius: 8px; border: 1px dashed var(--success);">
                            <p style="margin-top: 0; white-space: pre-wrap;"><?php echo e($todayReport->content); ?></p>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($todayReport->attachment_path): ?>
                                <a href="<?php echo e(asset('storage/' . $todayReport->attachment_path)); ?>" target="_blank" style="color: var(--accent); font-size: 13px;"><i class="fa-solid fa-paperclip"></i> View Attachment</a>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    ...
                    <?php else: ?>
                        <form method="POST" action="<?php echo e(route('master-demo.employee.report')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                ...
                                <select name="task_id" class="form-control" style="background: rgba(0,0,0,0.5); margin-bottom: 12px;" required>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $user->tasks()->where('type', 'goal')->where('status', '!=', 'completed')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <option value="<?php echo e($goal->id); ?>"><?php echo e($goal->title); ?> (Deadline: <?php echo e($goal->deadline ? $goal->deadline->format('d M Y') : '-'); ?>)</option>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    ...
                    <div style="margin-top: 32px;">
                        ...
                        <table style="width: 100%; border-collapse: collapse; font-size: 12px; background: var(--bg-main); border-radius: 8px; overflow: hidden;">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $user->tasks()->where('type', 'daily')->where('status', 'completed')->orderByDesc('created_at')->take(10)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tugasSelesai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                                    <td style="padding: 10px;"><?php echo e($tugasSelesai->created_at->format('d M Y')); ?></td>
                                    <td style="padding: 10px; color: var(--accent);"><?php echo e($tugasSelesai->parent ? $tugasSelesai->parent->title : 'Lainnya'); ?></td>
                                    <td style="padding: 10px;"><?php echo e($tugasSelesai->title); ?></td>
                                </tr>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <tr>
                ...
                <section class="card">
                    ...
                    <form method="POST" action="<?php echo e(route('master-demo.employee.profile')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="bio" class="form-control" placeholder="Tuliskan bio atau moto kerja Anda di sini..."><?php echo e(old('bio', $user->bio)); ?></textarea>
                        </div>
        ...
        <div id="view-attendance" class="view-section">
            ...
            <div class="card" style="margin-bottom: 24px; border-left: 4px solid var(--accent);">
                <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 16px;">
                    ...
                    <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$activeAttendance): ?>
                            <form id="form-clock-in" method="POST" action="<?php echo e(route('master-demo.attendance.clock-in')); ?>">
                                <?php echo csrf_field(); ?>
                            ...
                            <form id="form-out-hours" method="POST" action="<?php echo e(route('master-demo.attendance.clock-in')); ?>">
                                <?php echo csrf_field(); ?>
                        ...
                        <?php elseif(!$activeAttendance->clock_out): ?>
                            <!-- Istirahat Controls -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$activeAttendance->rest_start): ?>
                                <form method="POST" action="<?php echo e(route('master-demo.attendance.rest-start')); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn" style="background: var(--warning); gap: 6px;"><i class="fa-solid fa-mug-hot"></i> Mulai Istirahat</button>
                                </form>
                            <?php elseif(!$activeAttendance->rest_end): ?>
                                <form method="POST" action="<?php echo e(route('master-demo.attendance.rest-end')); ?>">
                                    <?php echo csrf_field(); ?>
                            ...
                            <form id="form-clock-out" method="POST" action="<?php echo e(route('master-demo.attendance.clock-out')); ?>">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-danger" style="gap: 6px;"><i class="fa-solid fa-right-from-bracket"></i> Clock Out</button>
                            </form>
                        <?php else: ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px; margin-bottom: 24px;">
                ...
                <div class="card">
                    ...
                    <form method="POST" action="<?php echo e(route('master-demo.leave-request.store')); ?>">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                ...
                <div class="card" style="padding: 24px; border: 1px solid var(--panel-border); border-radius: 16px; box-shadow: 0 4px 20px rgba(0,0,0,0.05);">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('attendance_success')): ?>
                        <div style="background: rgba(12, 53, 39,0.1); border-left: 4px solid var(--success); color: var(--success); padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; font-size: 13px; display: flex; align-items: center;">
                            ...
                            <?php echo e(session('attendance_success')); ?>

                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                    <form id="form-overtime" method="POST" action="<?php echo e(route('master-demo.employee.overtime')); ?>" style="margin-bottom: 20px;">
                        <?php echo csrf_field(); ?>
                        <div class="form-group" style="margin-bottom: 16px;">
                            ...
                            <select name="overtime_type_id" class="ios-input" required style="width: 100%; padding: 12px; border-radius: 12px;">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $overtimeTypes ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <option value="<?php echo e($ot->id); ?>"><?php echo e($ot->name); ?> (Rp <?php echo e(number_format($ot->rate_per_hour, 0, ',', '.')); ?>/jam)</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                            </select>
                        </div>
                        <div class="form-group" style="margin-bottom: 16px;">
                    ...
                    <div style="margin-top: 30px; border-top: 1px dashed var(--panel-border); padding-top: 20px;">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 10px;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $myOvertimes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otReq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div style="display: flex; justify-content: space-between; align-items: center; background: var(--panel-secondary); padding: 12px 16px; border-radius: 12px; border: 1px solid var(--panel-border);">
                                    <div>
                                        <div style="font-weight: 600; font-size: 13px;"><?php echo e($otReq->overtimeType?->name ?? 'Lembur'); ?></div>
                                        <div style="font-size: 11px; color: var(--text-muted); margin-top: 4px;"><?php echo e(\Carbon\Carbon::parse($otReq->date)->format('d M Y')); ?> &bull; <?php echo e($otReq->hours); ?> Jam</div>
                                    </div>
                                    <div>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($otReq->status === 'pending'): ?>
                                        ...
                                        <?php elseif($otReq->status === 'approved'): ?>
            ...
            <div class="card">
                ...
                <div style="overflow-x: auto;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $myAttendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                ...
                                <tr style="border-bottom: 1px solid var(--panel-border);">
                                    <td style="padding: 10px 8px;"><?php echo e($cin?->format('d M Y') ?? '-'); ?></td>
                                    <td style="padding: 10px 8px; color: var(--success);"><?php echo e($cin?->format('H:i') ?? '-'); ?> WIB</td>
                                    <td style="padding: 10px 8px; color: var(--danger);"><?php echo e($cout ? $cout->format('H:i') . ' WIB' : '-'); ?></td>
                                    <td style="padding: 10px 8px;"><?php echo e($dur !== null ? floor($dur/60).'j '.($dur%60).'m' : '-'); ?></td>
                                    <td style="padding: 10px 8px;"><span class="pill <?php echo e($att->status === 'Present' ? 'success' : 'warning'); ?>"><?php echo e($att->status); ?></span></td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <div id="view-team-attendance" class="view-section">
            <div class="card">
                <h3>Riwayat Attendance Tim <?php echo e($user->divisionLabel()); ?></h3>
                <?php
                ...
                <div style="overflow-x: auto;">
                    <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $teamAttendances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tAtt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <?php
                                    $tz = config('app.timezone', 'Asia/Jakarta');
                                ...
                                ?>
                                <tr style="border-bottom: 1px solid var(--panel-border);">
                                    <td style="padding: 10px 8px; font-weight: 600;"><?php echo e($tAtt->user?->name ?? 'Unknown'); ?></td>
                                    <td style="padding: 10px 8px;"><?php echo e($tCin?->format('d M Y') ?? '-'); ?></td>
                                    <td style="padding: 10px 8px; color: var(--success);"><?php echo e($tCin?->format('H:i') ?? '-'); ?> WIB</td>
                                    <td style="padding: 10px 8px; color: var(--danger);"><?php echo e($tCout ? $tCout->format('H:i') . ' WIB' : '-'); ?></td>
                                    <td style="padding: 10px 8px;"><?php echo e($tDur !== null ? floor($tDur/60).'j '.($tDur%60).'m' : '-'); ?></td>
                                    <td style="padding: 10px 8px;"><span class="pill <?php echo e($tAtt->status === 'Present' ? 'success' : 'warning'); ?>"><?php echo e($tAtt->status); ?></span></td>
                                </tr>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <div id="view-chat" class="view-section">
            <div class="chat-layout">
                <div class="chat-channels">
                    ...
                    <div class="channel-item" onclick="loadChat('Manager_<?php echo e($user->reports_to_id ?? 0); ?>', event)"><i class="fa-solid fa-user"></i> <?php echo e($user->manager()?->name ?? 'Manager'); ?></div>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $myTasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div style="background: var(--bg-main); padding: 16px; border-radius: 8px; border-left: 4px solid var(--accent); margin-top: 16px;">
                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                            <strong style="font-size: 16px;"><?php echo e($task->title); ?></strong>
                            <span class="pill <?php echo e($task->status === 'completed' ? 'success' : 'warning'); ?>"><?php echo e(ucfirst($task->status)); ?></span>
                        </div>
                        <div style="color: var(--text-muted); font-size: 13px; margin-bottom: 12px;">Deadline: <?php echo e($task->due_date ? $task->due_date->format('d M Y') : 'Tanpa Deadline'); ?></div>
                        <div style="font-size: 13px; margin-bottom: 8px;"><?php echo e($task->description); ?></div>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <div id="view-payslips" class="view-section">
            <div class="card">
                ...
                <div id="payslips-content" style="display: none; margin-top: 24px;">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $payrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($slip->status, ['approved', 'paid'])): ?>
                        <details style="margin-bottom: 16px; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 16px;">
                            <summary style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; outline: none; list-style: none;">
                                <div>
                                    <strong style="display: block; font-size: 14px;">Periode: <?php echo e($slip->period_start->format('M Y')); ?></strong>
                                    <span style="font-size: 12px; color: var(--text-muted);">Total Take Home Pay: Rp <?php echo e(number_format($slip->net_amount, 0, ',', '.')); ?></span>
                                </div>
                                <div style="display: flex; gap: 8px; align-items: center;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slip->status === 'paid'): ?>
                            ...
                            <div style="margin-top: 16px; padding: 16px; background: rgba(255,255,255,0.02); border-radius: 8px; font-size: 13px;">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                    ...
                                    <strong>Rp <?php echo e(number_format($slip->base_amount, 0, ',', '.')); ?></strong>
                                </div>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slip->items && count($slip->items) > 0): ?>
                                    <hr style="border: 0; border-top: 1px dashed rgba(255,255,255,0.1); margin: 12px 0;">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $slip->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                            <span style="color: var(--text-muted);"><?php echo e($item->description); ?></span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->type === 'allowance'): ?>
                                                <strong style="color: var(--success);">+ Rp <?php echo e(number_format($item->amount, 0, ',', '.')); ?></strong>
                                            <?php else: ?>
                                                <strong style="color: var(--danger);">- Rp <?php echo e(number_format($item->amount, 0, ',', '.')); ?></strong>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <div style="display: flex; justify-content: space-between;">
                                    ...
                                    <strong style="font-size: 16px; color: var(--accent);">Rp <?php echo e(number_format($slip->net_amount, 0, ',', '.')); ?></strong>
                                </div>
                                <div style="margin-top: 16px; display: flex; gap: 8px;">
                                    <a href="<?php echo e(route('master-demo.payroll.slip.preview', $slip->user_id)); ?>" target="_blank" class="user-pill" style="background: rgba(255,255,255,0.1); color: white; border: none; cursor: pointer; text-decoration: none; display: inline-block; text-align: center; flex: 1;">
                                        <i class="fa-solid fa-print"></i> Print Preview
                                    </a>
                                    <button onclick="downloadSlipPdf(<?php echo e($slip->user_id); ?>)" class="user-pill" style="background: var(--accent); color: white; border: none; cursor: pointer; text-decoration: none; display: inline-block; text-align: center; flex: 1;">
        ...
        <div id="view-profile" class="view-section">
            <div class="card">
                ...
                <form action="<?php echo e(route('master-demo.employee.profile')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="bio" class="form-control" placeholder="Tuliskan bio singkat..."><?php echo e($user->bio); ?></textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="grid-2">
                ...
                <div class="card">
                    ...
                    <div style="background: var(--bg-main); padding: 16px; border-radius: 8px; border: 1px solid var(--panel-border);">
                        <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\StockMovement::select('product_id', \Illuminate\Support\Facades\DB::raw('SUM(quantity) as total_qty'))->where('company_id', $companyId)->groupBy('product_id')->with('product')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stock): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    ...
                                    <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                                        <td style="padding: 8px;"><?php echo e($stock->product->name); ?></td>
                                        ...
                                        <td style="padding: 8px;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($stock->total_qty > 50000): ?>
                                                <span class="pill" style="background: rgba(12, 53, 39,0.2); color: var(--success);">Aman</span>
                                            <?php elseif($stock->total_qty > 10000): ?>
                ...
                <div class="card">
                    ...
                    <div style="margin-bottom: 24px; background: var(--bg-main); padding: 16px; border-radius: 8px;">
                        ...
                        <form method="POST" action="<?php echo e(route('master-demo.bom.store')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group" style="margin-bottom: 12px;">
                                ...
                                <select name="product_id" class="form-control" required>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $boms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div style="background: rgba(0,0,0,0.1); border: 1px solid var(--panel-border); border-radius: 8px; padding: 12px;">
                                <div style="font-weight: bold; margin-bottom: 4px;"><?php echo e($bom->name); ?></div>
                                <div style="font-size: 12px; color: var(--accent); margin-bottom: 8px;">For: <?php echo e($bom->product?->name); ?></div>
                                <div style="font-size: 11px; color: var(--text-muted);">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bom->lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div>- <?php echo e($line->component?->name); ?> (<?php echo e($line->quantity_per_unit); ?>)</div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                </div>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                ...
                <div class="card">
                    ...
                    <div style="margin-bottom: 24px; background: var(--bg-main); padding: 16px; border-radius: 8px;">
                        ...
                        <form method="POST" action="<?php echo e(route('master-demo.wo.store')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group" style="margin-bottom: 12px;">
                                <label>Rencana Tanggal Produksi</label>
                                <input type="date" name="planned_date" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required>
                            </div>
                            <div id="wo-rows-container">
                                <div class="wo-row" style="display: flex; gap: 8px; margin-bottom: 12px;">
                                    <select name="work_orders[0][bill_of_material_id]" class="form-control" style="flex: 2;" required>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $boms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bom): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 16px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $wos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div style="border: 1px solid var(--panel-border); border-left: 4px solid <?php echo e($wo->status === 'completed' ? 'var(--success)' : ($wo->status === 'in_progress' ? 'var(--warning)' : 'var(--accent)')); ?>; border-radius: 8px; padding: 16px;">
                                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                                    <div style="font-weight: bold; font-size: 14px;"><?php echo e($wo->number); ?></div>
                                    <span class="pill <?php echo e($wo->status === 'completed' ? 'success' : ($wo->status === 'in_progress' ? 'warning' : '')); ?>"><?php echo e(strtoupper($wo->status)); ?></span>
                                </div>
                                <div style="font-size: 12px; margin-bottom: 12px;">Target: <strong><?php echo e($wo->planned_quantity); ?></strong> x <?php echo e($wo->product?->name); ?> | Tgl: <?php echo e($wo->planned_date?->format('d M Y')); ?></div>
                                
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wo->status !== 'completed'): ?>
                                    <!-- Materials to Consume -->
                                    <div style="font-size: 11px; margin-bottom: 12px;">
                                        <strong>Bahan Baku:</strong>
                                        <ul style="padding-left: 16px; margin: 4px 0;">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $wo->materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <li style="margin-bottom: 6px;">
                                                    <div style="display: flex; justify-content: space-between; align-items: center;">
                                                        <span><?php echo e($mat->product?->name); ?> (Butuh: <?php echo e($mat->planned_quantity); ?>, Di-issue: <?php echo e($mat->issued_quantity); ?>, Terpakai: <span style="color: <?php echo e($mat->actual_quantity >= $mat->planned_quantity ? 'var(--success)' : 'var(--warning)'); ?>"><?php echo e($mat->actual_quantity); ?></span>)</span>
                                                        <div style="display: flex; gap: 4px;">
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mat->issued_quantity < $mat->planned_quantity): ?>
                                                            <form method="POST" action="<?php echo e(route('master-demo.wo.issue', $wo->id)); ?>" style="display: inline;">
                                                                <?php echo csrf_field(); ?>
                                                                <input type="hidden" name="material_id" value="<?php echo e($mat->id); ?>">
                                                                <input type="hidden" name="quantity" value="<?php echo e($mat->planned_quantity - $mat->issued_quantity); ?>">
                                                            ...
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($mat->actual_quantity < $mat->issued_quantity): ?>
                                                            <form method="POST" action="<?php echo e(route('master-demo.wo.consume', $wo->id)); ?>" style="display: inline;">
                                                                <?php echo csrf_field(); ?>
                                                                <input type="hidden" name="material_id" value="<?php echo e($mat->id); ?>">
                                                                <input type="hidden" name="quantity" value="<?php echo e($mat->issued_quantity - $mat->actual_quantity); ?>">
                                    ...
                                    <!-- Report Waste -->
                                    <form method="POST" action="<?php echo e(route('master-demo.wo.waste', $wo->id)); ?>" style="margin-bottom: 12px; display: flex; gap: 6px; align-items: center; background: rgba(239,68,68,0.05); padding: 8px; border-radius: 4px; border: 1px dashed var(--danger);">
                                        <?php echo csrf_field(); ?>
                                        <select name="product_id" class="form-control" style="font-size: 10px; padding: 4px; flex: 2;" required>
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $wo->materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <option value="<?php echo e($mat->product_id); ?>"><?php echo e($mat->product?->name); ?></option>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                        </select>
                                    ...
                                    <!-- Complete WO -->
                                    <form method="POST" action="<?php echo e(route('master-demo.wo.complete', $wo->id)); ?>" style="text-align: right;">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="completed_quantity" value="<?php echo e($wo->planned_quantity); ?>">
                                        <button type="submit" class="btn btn-outline" style="background: var(--success); color: white; border: none; font-size: 12px;"><i class="fa-solid fa-check-double"></i> Selesai (<?php echo e($wo->planned_quantity); ?> unit)</button>
                                    </form>
                                <?php else: ?>
                                    <div style="font-size: 12px; color: var(--success);"><i class="fa-solid fa-check"></i> Produksi selesai: <?php echo e($wo->completed_quantity); ?> unit.</div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($wo->wastes->count() > 0): ?>
                                        <div style="font-size: 11px; color: var(--danger); margin-top: 4px;">Terjadi <?php echo e($wo->wastes->count()); ?> pemborosan (waste) selama produksi.</div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        ...
        <div id="view-hierarchy" class="view-section">
            ...
            <div class="org-vertical-container">
                    ...
                    <div class="division-content" style="background: rgba(0,0,0,0.02);">
                        ...
                        <div class="org-tier">
                            ...
                            <div class="tier-cards">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($owners->isNotEmpty()): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $owners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php echo renderVerticalCard($owner, $user); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php else: ?>
                                    <?php echo renderVerticalCard(null, $user, true, 'Board of Directors', 'Owner / Shareholder'); ?>
                        ...
                        <div class="org-tier">
                            ...
                            <div class="tier-cards">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ceos->isNotEmpty()): ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ceos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ceo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php echo renderVerticalCard($ceo, $user); ?>

                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                <?php else: ?>
                                    <?php echo renderVerticalCard(null, $user, true, 'Chief Executive', 'CEO'); ?>
                ...
                <!-- DIVISIONS -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $divisionsStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divName => $divUsers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <?php
                    ...
                    <details class="division-accordion" <?php echo e($isMyDiv ? 'open' : ''); ?>>
                        <summary class="division-summary">
                            <span>
                                <i class="fa-solid fa-layer-group" style="color: var(--accent); margin-right: 8px;"></i> 
                                <?php echo e($divName ?: 'Unassigned Division'); ?>

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isMyDiv): ?>
                            ...
                            <span style="font-size: 12px; font-weight: normal; color: var(--text-muted);"><?php echo e($divUsers->count()); ?> orang <i class="fa-solid fa-chevron-down" style="margin-left: 8px;"></i></span>
                        </summary>
                        ...
                        <div class="division-content">
                            ...
                            <div class="org-tier">
                                ...
                                <div class="tier-cards">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($managers->isNotEmpty()): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $managers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mgr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                            <?php echo renderVerticalCard($mgr, $user); ?>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                    <?php else: ?>
                                        <?php echo renderVerticalCard(null, $user, true, 'Direct Report to CEO', 'Interim Oversight'); ?>
                            ...
                            <!-- SPV Tier -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($spvs->isNotEmpty()): ?>
                            <div class="org-tier">
                                <span class="tier-label">Supervisor</span>
                                <div class="tier-cards">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $spvs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $spv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php echo renderVerticalCard($spv, $user); ?>
                            ...
                            <!-- PIC Tier -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pics->isNotEmpty()): ?>
                            <div class="org-tier">
                                ...
                                <div class="tier-cards">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $pics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php echo renderVerticalCard($pic, $user); ?>
                            ...
                            <!-- Staff Tier -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($staffs->isNotEmpty()): ?>
                            <div class="org-tier">
                                <span class="tier-label">Staff</span>
                                <div class="tier-cards staff-grid">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <?php echo renderVerticalCard($stf, $user); ?>
        ...
        <div id="view-pos" class="view-section">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$activeSession): ?>
                <div class="card" style="max-width: 400px; margin: 40px auto; text-align: center;">
                    ...
                    <form method="post" action="<?php echo e(route('master-demo.pos.open')); ?>">
                        <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                    <div>
                        ...
                        <div style="font-size: 12px; color: var(--success);"><i class="fa-solid fa-circle" style="font-size: 8px;"></i> Sesi Aktif: Sejak <?php echo e($activeSession->opened_at->format('H:i')); ?></div>
                    </div>
                    <form method="post" action="<?php echo e(route('master-demo.pos.close')); ?>">
                        <?php echo csrf_field(); ?>
                ...
                <div class="grid-2">
                    ...
                    <div class="card">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\Product::where('company_id', $user->company_id ?? 1)->where('standard_cost', '>', 0)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div style="background: var(--bg-main); border: 1px solid var(--panel-border); border-radius: 8px; padding: 12px; cursor: pointer; transition: all 0.2s;" class="pos-item" onclick="addToCart(<?php echo e($product->id); ?>, '<?php echo e($product->name); ?>', <?php echo e($product->standard_cost * 2); ?>)">
                                <div style="font-weight: bold; font-size: 14px; margin-bottom: 4px;"><?php echo e($product->name); ?></div>
                                <div style="font-size: 12px; color: var(--text-muted);"><?php echo e($product->sku); ?></div>
                                <div style="color: var(--accent); font-weight: bold; margin-top: 8px;">Rp <?php echo e(number_format($product->standard_cost * 2, 0, ',', '.')); ?></div>
                            </div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </div>
                    </div>
        ...
        <div id="view-goals" class="view-section">
            ...
            <div class="card" style="margin-bottom: 24px; padding: 24px;">
                ...
                <?php
                    $myGoals = \App\Models\Task::where('user_id', $user->id)
                        ...
                        ->get();
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($myGoals->count() > 0): ?>
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $myGoals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div style="background: rgba(255,255,255,0.05); border: 1px solid var(--panel-border); border-radius: 8px; padding: 16px;">
                                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px;">
                                    <strong style="font-size: 16px;"><?php echo e($goal->title); ?></strong>
                                    <span class="org-badge badge-role"><?php echo e($goal->status); ?></span>
                                </div>
                                <p class="desc" style="font-size: 13px; margin-bottom: 12px;"><?php echo e($goal->description ?? 'Tidak ada deskripsi'); ?></p>
                            </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
                <?php else: ?>
            ...
            <div class="card" style="padding: 24px;">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $teamKpis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kpi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td><?php echo e($kpi->title); ?></td>
                            <td><?php echo e($kpi->user->name ?? 'N/A'); ?></td>
                            <td><?php echo e($kpi->parent->title ?? 'N/A'); ?></td>
                            <td><?php echo e($kpi->deadline ? $kpi->deadline->format('d M Y') : 'N/A'); ?></td>
                            <td><span class="org-badge badge-role" style="font-size:10px;"><?php echo e($kpi->status); ?></span></td>
                        </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        <tr>
                ...
                <form method="POST" action="<?php echo e(route('master-demo.tasks.store') ?? '#'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="parent_id" class="form-control" required>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $myGoals ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $goal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($goal->id); ?>"><?php echo e($goal->title); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="username" class="form-control" required>
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $myStaffsList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($stf->username); ?>"><?php echo e($stf->name); ?> (<?php echo e($stf->job_title ?? 'Staff'); ?>)</option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function switchView(viewId) {
            ...
            // Update Title
            const titles = {
                'dashboard': ['Dashboard', '<?php echo e($user->isManager() ? "Kelola tim dan pantau performa divisi " . $user->divisionLabel() . "." : "Overview performa kerja Anda."); ?>'],
        ...
        async function processSale() {
            ...
            try {
                const response = await fetch('<?php echo e(route("master-demo.pos.sale")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
...
<?php /**PATH D:\suba-erp-master-local-latest\resources\views\employee-portal.blade.php ENDPATH**/ ?>