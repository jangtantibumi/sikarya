...
<div class="flex justify-between items-end mb-6">
    ...
    <a href="<?php echo e(route('inventory.transfers.create')); ?>" class="bg-erp-green hover:bg-emerald-400 text-gray-900 font-semibold py-2 px-4 rounded-lg text-xs flex items-center">
        ...
        <tbody class="divide-y divide-erp-border text-gray-800 dark:text-gray-200">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $transfers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr class="hover:bg-white/5">
                    <td class="py-3 px-4 font-mono font-bold text-erp-green"><?php echo e($tr->number); ?></td>
                    <td class="py-3 px-4"><?php echo e($tr->date); ?></td>
                    <td class="py-3 px-4 font-medium"><?php echo e(optional($tr->sourceWarehouse)->name); ?></td>
                    <td class="py-3 px-4 font-medium text-emerald-400"><?php echo e(optional($tr->destinationWarehouse)->name); ?></td>
                    <td class="py-3 px-4">
                        <span class="px-2 py-0.5 rounded text-[10px] font-semibold uppercase
                            <?php if($tr->status === 'approved'): ?> bg-emerald-500/20 text-emerald-300
                            <?php elseif($tr->status === 'rejected'): ?> bg-rose-500/20 text-rose-300
                    ...
                    <td class="py-3 px-4 text-center space-x-2">
                        <a href="<?php echo e(route('inventory.transfers.show', $tr->id)); ?>" class="text-blue-400 hover:underline"><i class="ph ph-eye text-base"></i></a>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tr->status === 'draft'): ?>
                            <form method="POST" action="<?php echo e(route('inventory.transfers.approve', $tr->id)); ?>" class="inline">
                                <?php echo csrf_field(); ?>
...
<div><?php echo e($transfers->links()); ?></div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('inventory.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\suba-erp-master-local-latest\resources\views\inventory\transfers\index.blade.php ENDPATH**/ ?>