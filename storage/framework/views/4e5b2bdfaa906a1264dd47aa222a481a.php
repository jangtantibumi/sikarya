...
<head>
    ...
    <title>Digital Membership Card - <?php echo e($customer->name); ?></title>
    ...
    <div class="digital-card">
        <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.15); padding-bottom: 16px;">
            <div>
                ...
                <div style="font-size: 22px; font-weight: 800; margin-top: 2px;"><?php echo e($customer->name); ?></div>
            </div>
            <span style="background: #D9EFE9; color: var(--text-accent); font-weight: 800; font-size: 12px; padding: 6px 14px; border-radius: 100px;">
                <?php echo e($customer->membership_level); ?>

            </span>
        </div>

        <div class="qr-box">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=<?php echo e($customer->customer_code); ?>" alt="QR Member">
            <div style="font-family: monospace; font-size: 14px; font-weight: 800; color: var(--text-accent); margin-top: 8px;"><?php echo e($customer->customer_code); ?></div>
        </div>
...
<?php /**PATH D:\suba-erp-master-local-latest\resources\views\portal\card.blade.php ENDPATH**/ ?>