<?php $__env->startSection('title', 'Dashboard CRM - F&B Portal'); ?>
...
<div class="welcome-header">
    ...
    <div class="quick-actions">
        <a href="<?php echo e(route('crm.customers.create')); ?>" class="btn btn-primary"><i class="ph ph-user-plus"></i> Customer Baru</a>
        <a href="<?php echo e(route('crm.reservations.index')); ?>" class="btn btn-secondary"><i class="ph ph-calendar-plus"></i> Cek Reservasi</a>
    </div>
</div>
...
<div class="metrics-grid">
    <div class="metric-card">
        ...
        <div class="metric-value"><?php echo e(number_format($totalCustomers)); ?></div>
    </div>
    <div class="metric-card">
        <div class="metric-header">
        ...
        <div class="metric-value success">+<?php echo e(number_format($newCustomers)); ?></div>
    </div>
    <div class="metric-card">
        <div class="metric-header">
        ...
        <div class="metric-value info"><?php echo e(number_format($repeatCustomers)); ?></div>
    </div>
    <div class="metric-card" style="background: var(--crm-primary); color: white;">
        ...
        <div class="metric-value" style="color: white;">
            <span class="metric-unit" style="color: rgba(255,255,255,0.7); margin-left:0; margin-right:4px;">Rp</span><?php echo e(number_format($totalSpending / 1000000, 1)); ?><span class="metric-unit" style="color: rgba(255,255,255,0.7);">M</span>
        </div>
    </div>
</div>
...
<div class="charts-grid">
    <div class="chart-card">
        ...
        <div class="bar-chart-container">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = range(1, 12); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                ?>
                <div class="bar-chart-col" title="<?php echo e($total); ?> Customers">
                    <div class="bar-chart-bar" style="height: <?php echo e($height); ?>%;"></div>
                    <div class="bar-chart-label"><?php echo e($months[$m-1]); ?></div>
                </div>
    ...
    <div class="chart-card">
        ...
        <div class="membership-list">
            <?php $totalDist = $membershipDistribution->sum('total') ?: 1; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['Guest', 'Silver', 'Gold', 'Platinum', 'Diamond']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                ...
                <div class="membership-item">
                    <div class="membership-item-header">
                        <span class="membership-item-label"><?php echo e($level); ?></span>
                        <span class="membership-item-val"><?php echo e($pct); ?>%</span>
                    </div>
                    <div class="membership-progress">
                        <div class="membership-progress-bar" style="width: <?php echo e($pct); ?>%;"></div>
                    </div>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
...
<div class="table-wrapper">
    <div class="table-header">
        ...
        <a href="<?php echo e(route('crm.customers.index')); ?>" class="btn btn-outline" style="padding: 6px 14px; font-size: 12px; border-radius: 8px;">Lihat Semua</a>
    </div>
    <table class="crm-table">
        ...
        <tbody>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <tr>
                <td>
                    <div style="font-weight: 600; color: #1e293b;"><?php echo e($c->name); ?></div>
                    <div style="font-size: 12px; color: #64748b; margin-top: 4px;"><i class="ph ph-phone"></i> <?php echo e($c->phone); ?></div>
                </td>
                <td><span class="badge badge-success"><?php echo e($c->membership_level); ?></span></td>
                <td><?php echo e($c->created_at->format('d/m/Y')); ?></td>
                <td style="color: var(--crm-primary); font-weight: 700;"><?php echo e(number_format($c->total_points)); ?> pts</td>
...
<?php echo $__env->make('crm.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\suba-erp-master-local-latest\resources\views/crm/dashboard.blade.php ENDPATH**/ ?>