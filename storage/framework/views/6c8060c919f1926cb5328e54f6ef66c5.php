                ...
                <form onsubmit="submitAddStaff(event)">
                    ...
                    <div class="form-group">
                        ...
                        <select name="division" id="add-staff-division" class="form-control" required onchange="updateGeneratedFields()">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = \App\Models\CompanyDivision::where('company_id', $company->id ?? 1)->orderBy('order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $div): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($div->name); ?>"><?php echo e($div->name); ?></option>
...
function populateManagerCandidates() {
    ...
    async function submitAddDivision(e) {
        ...
        try {
            const response = await fetch('<?php echo e(route('master-demo.divisions.store')); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
