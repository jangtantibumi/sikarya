<?php $__env->startSection('title', 'Advanced CRM Analytics - CLV, RFM & Churn'); ?>
...
<div class="grid-4">
    <div class="stat-card-enhanced">
        ...
        <div class="stat-value"><?php echo e(number_format($total_customers)); ?></div>
    </div>
    <div class="stat-card-enhanced">
        <div class="stat-title">Rata-rata CLV</div>
        <div class="stat-value" style="color: var(--text-accent);">Rp <?php echo e(number_format($clv['avg_clv'], 0, ',', '.')); ?></div>
    </div>
    <div class="stat-card-enhanced">
        <div class="stat-title">Repeat Rate</div>
        <div class="stat-value" style="color: var(--text-accent);"><?php echo e($repeat['repeat_rate']); ?>%</div>
    </div>
    <div class="stat-card-enhanced">
        <div class="stat-title">Churn Rate</div>
        <div class="stat-value" style="color: #dc2626;"><?php echo e($churn['churn_rate']); ?>%</div>
    </div>
</div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 24px;">
        <div class="crm-card">
            ...
            <div style="display: flex; flex-direction: column; gap: 16px;">
                <div style="padding: 12px; background: rgba(0,0,0,0.02); border-radius: 8px;">
                    ...
                    <div style="font-size: 18px; font-weight: 800; color: var(--crm-primary);">Rp <?php echo e(number_format($clv['avg_order_value'], 0, ',', '.')); ?></div>
                </div>
                <div style="padding: 12px; background: rgba(0,0,0,0.02); border-radius: 8px;">
                    <div style="font-size: 12px; color: #64748b; font-weight: 600;">Purchase Frequency</div>
                    <div style="font-size: 18px; font-weight: 800; color: var(--crm-primary);"><?php echo e($clv['avg_frequency']); ?> transaksi / customer</div>
                </div>
                <div style="padding: 12px; background: rgba(0,0,0,0.02); border-radius: 8px;">
                    <div style="font-size: 12px; color: #64748b; font-weight: 600;">Estimasi Customer Lifespan</div>
                    <div style="font-size: 18px; font-weight: 800; color: var(--crm-primary);"><?php echo e($clv['avg_lifespan_years']); ?> Tahun</div>
                </div>
            </div>
        </div>
        ...
        <div class="crm-card">
            ...
            <table class="crm-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $clv['top_clv_customers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td><strong><?php echo e($c->name); ?></strong> (<?php echo e($c->customer_code); ?>)</td>
                            <td><span class="badge badge-success"><?php echo e($c->membership_level); ?></span></td>
                            <td style="color: var(--text-accent); font-weight: 700;">Rp <?php echo e(number_format($c->total_spending, 0, ',', '.')); ?></td>
                            <td style="color: var(--crm-primary); font-weight: 800;">Rp <?php echo e(number_format($c->estimated_clv, 0, ',', '.')); ?></td>
                        </tr>
...
<div id="analytics-rfm" class="analytics-tab-content">
    <div class="crm-card">
        ...
        <div class="rfm-matrix-grid">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rfm['segments']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segName => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div class="rfm-cell">
                    <div style="font-size: 11px; font-weight: 700; color: #64748b; text-transform: uppercase;"><?php echo e($segName); ?></div>
                    <div style="font-size: 24px; font-weight: 800; color: var(--crm-primary); margin: 8px 0;"><?php echo e($count); ?></div>
        ...
        <table class="crm-table">
            ...
            <tbody>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $rfm['classified_customers']->take(15); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cust): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr>
                        <td><strong><?php echo e($cust->name); ?></strong> (<?php echo e($cust->customer_code); ?>)</td>
                        <td><span style="font-family: monospace; font-weight: 700; background: rgba(0,0,0,0.05); padding: 2px 8px; border-radius: 6px;"><?php echo e($cust->rfm_score); ?></span></td>
                        <td><span class="badge badge-success"><?php echo e($cust->rfm_segment); ?></span></td>
                        <td style="color: var(--text-accent); font-weight: 700;">Rp <?php echo e(number_format($cust->total_spending, 0, ',', '.')); ?></td>
                        <td><?php echo e($cust->last_visit ? $cust->last_visit->format('d/m/Y') : 'Belum pernah'); ?></td>
                    </tr>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </tbody>
        </table>
    ...
    <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 24px;">
        <div class="crm-card">
            ...
            <div style="text-align: center; padding: 32px 0;">
                <div style="font-size: 48px; font-weight: 800; color: var(--text-accent);"><?php echo e($repeat['repeat_rate']); ?>%</div>
            ...
            <div style="border-top: 1px solid var(--crm-border); padding-top: 16px; display: flex; justify-content: space-around;">
                <div>
                    ...
                    <div style="font-size: 18px; font-weight: 700; color: var(--text-accent);"><?php echo e($repeat['repeat_customers']); ?></div>
                </div>
                <div>
                    <div style="font-size: 11px; color: #64748b; text-transform: uppercase;">Single Customer</div>
                    <div style="font-size: 18px; font-weight: 700; color: #d97706;"><?php echo e($repeat['single_customers']); ?></div>
                </div>
            </div>
        </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 16px; justify-content: center; height: 200px;">
                <div>
                    <div style="display: flex; justify-content: space-between; font-size: 13px; font-weight: 600; margin-bottom: 6px;">
                        ...
                        <span><?php echo e($repeat['repeat_customers']); ?> Customer (<?php echo e($repeat['repeat_rate']); ?>%)</span>
                    </div>
                    <div style="height: 12px; background: rgba(0,0,0,0.05); border-radius: 6px; overflow: hidden;">
                        <div style="width: <?php echo e($repeat['repeat_rate']); ?>%; height: 100%; background: #0C3527;"></div>
                    </div>
                </div>
                <div>
                    <div style="display: flex; justify-content: space-between; font-size: 13px; font-weight: 600; margin-bottom: 6px;">
                        <span>First-Time Customers (1 Visit/Order)</span>
                        <span><?php echo e($repeat['single_customers']); ?> Customer (<?php echo e(100 - $repeat['repeat_rate']); ?>%)</span>
                    </div>
                    <div style="height: 12px; background: rgba(0,0,0,0.05); border-radius: 6px; overflow: hidden;">
                        <div style="width: <?php echo e(100 - $repeat['repeat_rate']); ?>%; height: 100%; background: #d97706;"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 24px;">
        <div class="crm-card">
            ...
            <div style="text-align: center; padding: 24px 0;">
                <div style="font-size: 44px; font-weight: 800; color: #dc2626;"><?php echo e($churn['churn_rate']); ?>%</div>
            ...
            <div style="border-top: 1px solid var(--crm-border); padding-top: 16px; display: flex; justify-content: space-around;">
                <div>
                    ...
                    <div style="font-size: 18px; font-weight: 700; color: var(--text-accent);"><?php echo e($churn['active_count']); ?></div>
                </div>
                <div>
                    <div style="font-size: 11px; color: #64748b;">Customer Churned</div>
                    <div style="font-size: 18px; font-weight: 700; color: #dc2626;"><?php echo e($churn['churned_count']); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="crm-card">
            ...
            <table class="crm-table">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $churn['risk_customers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr>
                            <td><strong><?php echo e($c->name); ?></strong> (<?php echo e($c->customer_code); ?>)</td>
                            <td><?php echo e($c->phone); ?></td>
                            <td style="color: var(--text-accent); font-weight: 700;">Rp <?php echo e(number_format($c->total_spending, 0, ',', '.')); ?></td>
                            <td style="color: #dc2626; font-weight: 600;"><?php echo e($c->last_visit ? $c->last_visit->format('d/m/Y') : 'Lama'); ?></td>
                            <td style="text-align: right;">
                                <a href="<?php echo e(route('crm.marketing.campaigns')); ?>" class="btn btn-outline" style="padding: 4px 10px; font-size: 11px;"><i class="ph ph-paper-plane-right"></i> Kirim Win-back Offer</a>
                            </td>
                        </tr>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
...
<div id="analytics-trends" class="analytics-tab-content">
    <div class="crm-card">
        ...
        <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 16px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $trends; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <div>
                    <div style="display: flex; justify-content: space-between; font-size: 13px; font-weight: 600; margin-bottom: 6px;">
                        <span><?php echo e($tr['label']); ?></span>
                        <span style="color: var(--text-accent); font-weight: 700;">Rp <?php echo e(number_format($tr['spending'], 0, ',', '.')); ?></span>
                    </div>
                    <div style="height: 10px; background: rgba(0,0,0,0.05); border-radius: 5px; overflow: hidden;">
                        ...
                        ?>
                        <div style="width: <?php echo e($widthPct); ?>%; height: 100%; background: var(--crm-primary);"></div>
                    </div>
                </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
...
<?php echo $__env->make('crm.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\suba-erp-master-local-latest\resources\views\crm\analytics\index.blade.php ENDPATH**/ ?>