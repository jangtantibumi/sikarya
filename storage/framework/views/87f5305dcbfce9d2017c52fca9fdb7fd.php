<?php $__env->startSection('title', 'Laporan Gudang & Stok'); ?>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="glass-panel p-6 rounded-xl border border-gray-200 dark:border-erp-border">
        ...
        <div class="text-2xl font-bold text-emerald-400 font-mono">Rp <?php echo e(number_format($totalValuation ?? 450000000)); ?></div>
    ...
    <div class="glass-panel p-6 rounded-xl border border-gray-200 dark:border-erp-border">
        ...
        <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($warehouseSummaries->count()); ?> Gudang</div>
...
<div class="glass-panel p-6 rounded-xl border border-gray-200 dark:border-erp-border">
    ...
    <table class="w-full text-left text-xs">
        ...
        <tbody class="divide-y divide-erp-border text-gray-800 dark:text-gray-200">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $topItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemRow): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <tr>
                    <td class="py-3 px-4 font-semibold text-gray-900 dark:text-white"><?php echo e(optional($itemRow->item)->name); ?> <span class="text-gray-500 dark:text-gray-500">(<?php echo e(optional($itemRow->item)->sku); ?>)</span></td>
                    <td class="py-3 px-4 font-bold text-emerald-400"><?php echo e(number_format($itemRow->total_qty)); ?></td>
                </tr>
...
<?php echo $__env->make('inventory.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\suba-erp-master-local-latest\resources\views\inventory\reports\index.blade.php ENDPATH**/ ?>