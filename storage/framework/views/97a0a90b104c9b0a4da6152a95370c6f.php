...
>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($metadata['logo']): ?>
        <img slot="logo" src="<?php echo $metadata['logo']; ?>"/>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</rapi-doc>
</body>
</html>
<?php /**PATH D:\suba-erp-master-local-latest\vendor\knuckleswtf\scribe\resources\views\external\rapidoc.blade.php ENDPATH**/ ?>