...
<body>
    <main class="access-shell">
        <section class="access-card">
            ...
            <form method="POST" action="<?php echo e(route('erp-access.verify')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['access_password'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="security-note">
                <span>◈</span>
                <span>Akses berlaku selama <?php echo e($sessionHours); ?> jam pada sesi browser ini. Jangan membagikan password melalui kanal publik.</span>
            </div>
        </section>
    </main>
    <script>
...
<?php /**PATH D:\suba-erp-master-local-latest\resources\views\access-gate.blade.php ENDPATH**/ ?>