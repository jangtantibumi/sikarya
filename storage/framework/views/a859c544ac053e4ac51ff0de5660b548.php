...
<div style="max-width: 600px; margin: 0 auto; background: var(--erp-bg); min-height: 100vh;">
    ...
    <div class="card-profile">
        <form action="<?php echo e(route('portal.profile.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="form-group mb-3">
                <label style="font-size: 12px; font-weight: 700; color: #64748b; text-transform: uppercase;">Kode Customer</label>
                <input type="text" class="form-control" value="<?php echo e($customer->customer_code); ?>" disabled style="opacity: 0.7;">
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo e($customer->phone); ?>" disabled style="opacity: 0.7;">
            </div>
            ...
            <div class="row mb-3">
                <div class="col-6">
                    ...
                    <select name="gender" class="form-control">
                        ...
                        <option value="male" <?php echo e($customer->gender === 'male' ? 'selected' : ''); ?>>Laki-laki</option>
                        <option value="female" <?php echo e($customer->gender === 'female' ? 'selected' : ''); ?>>Perempuan</option>
                    </select>
                </div>
                <div class="col-6">
                    <label style="font-size: 12px; font-weight: 700; color: #64748b; text-transform: uppercase;">Tgl Lahir</label>
                    <input type="date" name="birth_date" class="form-control" value="<?php echo e($customer->birth_date ? $customer->birth_date->format('Y-m-d') : ''); ?>">
                </div>
            </div>
    ...
    <div class="bottom-nav">
        ...
        <a href="<?php echo e(route('portal.profile')); ?>" class="bottom-nav-item active"><i class="ph-fill ph-user"></i><span>Profil</span></a>
    </div>
</div>
</body>
</html>
<?php /**PATH D:\suba-erp-master-local-latest\resources\views\portal\profile.blade.php ENDPATH**/ ?>