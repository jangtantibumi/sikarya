...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'CRM & Customer Portal'); ?></title>
...
<div class="crm-layout">
    <aside class="crm-sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('crm.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.dashboard') ? 'active' : ''); ?>">
                <i class="ph ph-squares-four nav-icon"></i> Dashboard
            </a>
            <a href="<?php echo e(route('crm.customers.index')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.customers.*') ? 'active' : ''); ?>">
                <i class="ph ph-users nav-icon"></i> Customer
            </a>
            <a href="<?php echo e(route('crm.memberships.index')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.memberships.*') ? 'active' : ''); ?>">
                <i class="ph ph-crown nav-icon"></i> Membership
            </a>
            <a href="<?php echo e(route('crm.loyalties.index')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.loyalties.*') ? 'active' : ''); ?>">
                <i class="ph ph-gift nav-icon"></i> Loyalty
            </a>
            <a href="<?php echo e(route('crm.vouchers.index')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.vouchers.*') ? 'active' : ''); ?>">
                <i class="ph ph-ticket nav-icon"></i> Voucher
            </a>
            <a href="<?php echo e(route('crm.reservations.index')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.reservations.*') ? 'active' : ''); ?>">
                <i class="ph ph-calendar-check nav-icon"></i> Reservation
            </a>
            <a href="<?php echo e(route('crm.feedbacks.index')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.feedbacks.*') ? 'active' : ''); ?>">
                <i class="ph ph-star nav-icon"></i> Feedback
            </a>
            <a href="<?php echo e(route('crm.analytics.index')); ?>" class="nav-item <?php echo e(request()->routeIs('crm.analytics.*') ? 'active' : ''); ?>">
                <i class="ph ph-chart-line-up nav-icon"></i> Analytics
            </a>
            <a href="<?php echo e(route('portal.login')); ?>" class="nav-item" target="_blank">
    ...
    <main class="crm-main">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('success')): ?>
            <div class="alert alert-success"><i class="ph ph-check-circle" style="font-size: 20px;"></i> <?php echo e(session('success')); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($errors->any()): ?>
            <div class="alert alert-error"><i class="ph ph-warning-circle" style="font-size: 20px;"></i> <?php echo e($errors->first()); ?></div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php /**PATH D:\suba-erp-master-local-latest\resources\views\crm\layouts\app.blade.php ENDPATH**/ ?>