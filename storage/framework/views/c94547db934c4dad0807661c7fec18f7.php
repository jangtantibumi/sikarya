<?php $__env->startSection('title', 'Tambah Gudang Baru'); ?>
...
<div class="max-w-2xl mx-auto">
    ...
    <form method="POST" action="<?php echo e(route('inventory.warehouses.store')); ?>" class="glass-panel p-6 rounded-xl border border-gray-200 dark:border-erp-border space-y-4">
        <?php echo csrf_field(); ?>
        <div>
            <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Kode Gudang *</label>
            <input type="text" name="code" value="WH-<?php echo e(rand(100, 999)); ?>" required class="w-full bg-gray-50 dark:bg-erp-dark border border-gray-200 dark:border-erp-border rounded-lg px-3 py-2 text-xs text-gray-900 dark:text-white">
        </div>
        <div>
...
<?php echo $__env->make('inventory.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\suba-erp-master-local-latest\resources\views\inventory\warehouses\create.blade.php ENDPATH**/ ?>