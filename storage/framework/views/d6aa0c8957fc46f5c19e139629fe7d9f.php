...
<div style="max-width: 600px; margin: 0 auto; background: var(--erp-bg); min-height: 100vh;">
    ...
    <div style="padding: 16px 20px;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $timelines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <div class="invoice-card">
                <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                    <div>
                        <div style="font-weight: 700; font-size: 14px; color: #1e293b;"><?php echo e($tm->action); ?></div>
                        <div style="font-size: 13px; color: #64748b; margin-top: 4px;"><?php echo e($tm->description); ?></div>
                    </div>
                ...
                <div style="font-size: 11px; color: #94a3b8; margin-top: 10px; border-top: 1px solid rgba(0,0,0,0.05); padding-top: 8px;">
                    <?php echo e($tm->created_at->format('d F Y, H:i')); ?>
    ...
    <div class="bottom-nav">
        ...
        <a href="<?php echo e(route('portal.invoices')); ?>" class="bottom-nav-item active"><i class="ph-fill ph-receipt"></i><span>Transaksi</span></a>
        <a href="<?php echo e(route('portal.profile')); ?>" class="bottom-nav-item"><i class="ph-fill ph-user"></i><span>Profil</span></a>
    </div>
</div>
</body>
</html>
<?php /**PATH D:\suba-erp-master-local-latest\resources\views\portal\invoices.blade.php ENDPATH**/ ?>