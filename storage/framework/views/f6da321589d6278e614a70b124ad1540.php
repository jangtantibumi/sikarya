<?php $__env->startSection('title', 'Merge Customer Duplikat - CRM Portal'); ?>
...
<div style="max-width: 800px; margin: 0 auto; background: var(--crm-bg-card); border: 1px solid var(--crm-border); border-radius: var(--crm-radius); padding: 32px; box-shadow: var(--crm-shadow);">
    <form action="<?php echo e(route('crm.customers.merge')); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menggabungkan customer ini? Tindakan ini akan memindahkan poin, spending, serta riwayat dari Customer Sumber ke Customer Target.');">
        <?php echo csrf_field(); ?>
                ...
                <select name="source_id" class="form-control" required style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid var(--crm-border);">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <option value="<?php echo e($c->id); ?>">
                            <?php echo e($c->name); ?> (<?php echo e($c->customer_code); ?>) - <?php echo e($c->phone); ?>
...
<?php echo $__env->make('crm.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\suba-erp-master-local-latest\resources\views\crm\customers\merge.blade.php ENDPATH**/ ?>