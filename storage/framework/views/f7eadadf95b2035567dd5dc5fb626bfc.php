<?php $__env->startSection('title', 'Kategori Gudang & Stok'); ?>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="glass-panel p-5 rounded-xl border border-gray-200 dark:border-erp-border h-fit">
        ...
        <form method="POST" action="<?php echo e(route('inventory.categories.store')); ?>" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
                <label class="block text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">Kode Kategori *</label>
                <input type="text" name="code" value="CAT-<?php echo e(rand(100, 999)); ?>" required class="w-full bg-gray-50 dark:bg-erp-dark border border-gray-200 dark:border-erp-border rounded-lg px-3 py-1.5 text-xs text-gray-900 dark:text-white">
            </div>
            <div>
            ...
            <tbody class="divide-y divide-erp-border text-gray-800 dark:text-gray-200">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr class="hover:bg-white/5">
                        <td class="py-3 px-4 font-mono text-erp-green font-semibold"><?php echo e($cat->code); ?></td>
                        <td class="py-3 px-4 font-semibold text-gray-900 dark:text-white"><?php echo e($cat->name); ?></td>
                        <td class="py-3 px-4 text-gray-700 dark:text-gray-300 font-mono"><?php echo e($cat->items_count); ?> items</td>
                        <td class="py-3 px-4 text-center">
                            <form method="POST" action="<?php echo e(route('inventory.categories.destroy', $cat->id)); ?>" class="inline" onsubmit="return confirm('Hapus kategori ini?')">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('inventory.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\suba-erp-master-local-latest\resources\views\inventory\categories\index.blade.php ENDPATH**/ ?>