    ...
    window.purchasingApp = {
        ...
        loadProducts: async function() {
            try {
                ...
                this.products = data.products?.data || data.products || [];
        ...
        loadPOs: async function() {
            ...
            try {
                ...
                container.innerHTML = `<div style="color:red; text-align:center; padding: 20px; font-weight: bold;">Gagal memuat data PO. Error: ${e.message}</div>`;
            }
        },
